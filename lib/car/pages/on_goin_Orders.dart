...
import 'package:norwayfinalcustomer/NotificationClasses/postRequest.dart';
...
import 'package:norwayfinalcustomer/car/pages/carDeliveryMessage.dart';
...
class On_Going_Order extends StatefulWidget {
  final set;
  const On_Going_Order({Key key, this.set})
      : super(key: key);
  @override
...
class _On_Going_OrderState extends State<On_Going_Order> {
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          // InkWell(
                          //     onTap: (){
                          //       Navigator.push(context, MaterialPageRoute(builder: (context) => CarDeliveryMessage()));
                          //     },
                          //     child: Icon(Icons.message,size: 15,color: AppColors.blueColor,)
                          // )
                        ],
                      ),
                    )
  ...
  _sendnotification(String id){
    SplashTest.toke.clear();
    final FirebaseDatabase database1 = FirebaseDatabase.instance;
    DatabaseReference ref2 = database1.reference().child('DriverTokens').child(id);
      ...
      mapOfMapss.values.forEach( (value2) {
        setState(() {
          ...
          if(SplashTest.toke.length == 1) {
            postRequest()
                .makePostRequest(
                "Ride Cancelled", ""+UserData.Name+"Customer cancle the Ride", SplashTest.toke[0].toString());
      ...
      child: Container(
        ...
        child: Column(
          children: [
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: CircleAvatar(
                                ...
                                radius: 35,
                                backgroundImage: NetworkImage(
                                  pastOrdersModel.Serviceimage == null ? 'https://firebasestorage.googleapis.com/v0/b/norway-568bb.appspot.com/o/bike.png?alt=media&token=ad957b1d-74ee-4dde-b0ef-4b874b1b3ac6' : pastOrdersModel.Serviceimage.toString(),
                                ),
                              ),
                            ),
                          ),
            ...
            Visibility(
              visible: pastOrdersModel.isJourneyCancelled==true?false:true,
              child: Container(
                margin: EdgeInsets.symmetric(horizontal: 10),
                width: size.width / 1,
                ...
                child: Row(
                  ...
                  children: [
                    RaisedButton(
                      onPressed: (){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => TrackDriver(pastOrdersModel:pastOrdersModel,)));
                      },
                    ...
                    RaisedButton(
                        onPressed: (){
                          _sendnotification(pastOrdersModel.acceptedByID);
                          databaseReference
  ...
  Widget RideStatus(PastOrdersModel pastOrdersModel){
    if(pastOrdersModel.isAccepted==true && pastOrdersModel.isPickedUp==false && pastOrdersModel.isJourneyCancelled==false){
        return  Container(
          ...
          child: Row(
            children: [
              ...
              SizedBox(width: 10,),
              Text("Your driver is the on way",style: TextStyle(fontSize: 14),)
            ],
          ),
        );
    }else if(pastOrdersModel.isPickedUp==true && pastOrdersModel.isJourneyEnded==false && pastOrdersModel.isJourneyCancelled==false){
        return  Container(
          margin: EdgeInsets.symmetric(vertical: 8),
          child: Row(
            children: [
    ...
    }else if(pastOrdersModel.isJourneyCancelledbyCustomer==true && pastOrdersModel.isJourneyCancelled==true){
      return  Container(
        margin: EdgeInsets.symmetric(vertical: 8),
        child: Row(
          children: [
            ...
            Icon(Icons.adjust,size: 15,color: Color(0xFF145c73)),
            SizedBox(width: 10,),
            Text("You have cancelled the Ride",style: TextStyle(fontSize: 16),)
          ],
        ),
      );
    }
    ...
    return  Container(
      ...
      child: Row(
        children: [
          ...
          Icon(Icons.adjust,size: 15,color: Color(0xFF145c73)),
          SizedBox(width: 10,),
          Text("Ride Has Been Sheduled..",style: TextStyle(fontSize: 14),)
        ],
      ),
    );
  }
