                    ...
                    child: Card(
                      child: InkWell(
                        ...
                        onTap: () {
                          ...
                          {
                            clickstatus=false;
                            if(globalvendors[index].lat != null && globalvendors[index].lng != null
                            && globalvendors[index].lat != "null" && globalvendors[index].lng != "null")
                            {
                              vendordistance = Distancee().distance1(
                                  double.parse(usercurrlat.toString()),
                                  double.parse(usercurrlng.toString()),
                                  double.parse(
                                      globalvendors[index].lat.toString()),
                                  double.parse(
                                      globalvendors[index].lng.toString()));
                            }
                            else{
                              vendordistance = 0.0;
                            }
